...
// **Ensure this matches the path used in your C++ server.**
const socketPath = "/tmp/junctiond.sock" 
...
func main() {
    ...
    if spawnErr != nil {
        // This is expected if your C++ server is currently set to 'return false'
